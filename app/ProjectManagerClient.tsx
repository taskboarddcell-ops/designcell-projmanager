  ...
  <div class="app">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div class="sb-body">
        ...
        <div class="proj-list">
          <div style="position: sticky; top: 0; background: var(--bg-sidebar); z-index: 10; padding-top: 8px; padding-bottom: 4px;">
...
export default function ProjectManagerClient() {
  ...
  useEffect(() => {
    ...
    function generateKanbanBoardReport(tasksToPrint: Task[], options: any) {
      ...
      if (filtersList) {
        filtersList.innerHTML = '';
        // Don't show statuses - they're obvious from the column headers
        if (options.dateFrom || options.dateTo) {
          const li = document.createElement('li');
          const filterModeLabel = options.filterMode === 'assigned' ? 'Assignment Date' :
            options.filterMode === 'completed' ? 'Completion Date' : 'Due Date';
